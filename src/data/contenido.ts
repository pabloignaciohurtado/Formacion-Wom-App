...
export const DOMINIOS: Dominio[] = [
  ...
  },
  {
    ...
    titulo: 'Club WOM',
    icono: '🎁',
    descripcion: 'Los beneficios y descuentos exclusivos por ser cliente WOM, y cómo convertirlos en valor para el cliente.',
    objetivos: [
      { id: 'cw-que-es', titulo: 'Qué es y quién accede' },
      { id: 'cw-uso', titulo: 'Cómo se activa y se usa' },
      { id: 'cw-recomendar', titulo: 'Recomendar el beneficio correcto' },
      { id: 'cw-valor', titulo: 'Comunicar el valor' },
    ],
    ejercicios: [
      { id: 'cw-01', objetivoId: 'cw-que-es', enunciado: '¿Qué es el Club WOM?', opciones: ['La plataforma de beneficios y descuentos exclusivos por ser cliente WOM, accesible desde la app', 'Un plan de telefonía con más gigas', 'Un seguro para el equipo', 'Un programa de puntos que se canjean por minutos'], correcta: 0, explicacion: 'El Club WOM es el programa de beneficios: descuentos y promociones con comercios (cine, comida, retail y más) solo por ser cliente WOM, accesibles desde la app.' },
      { id: 'cw-02', objetivoId: 'cw-que-es', enunciado: 'Un cliente prepago que no recarga hace más de un mes quiere usar los descuentos del Club WOM. ¿Qué corresponde?', opciones: ['Ya tiene acceso: todos los clientes WOM entran automáticamente', 'El Club WOM es solo para clientes de plan (postpago)', 'Necesita una recarga en los últimos 30 días para ser elegible; se lo explicas y lo invitas a recargar', 'Debe contratar un plan adicional para acceder'], correcta: 2, explicacion: 'El prepago accede al Club WOM manteniéndose activo con una recarga en los últimos 30 días. Confirmarlo con seguridad evita prometerle un beneficio que no podrá usar.' },
      { id: 'cw-03', objetivoId: 'cw-que-es', enunciado: '¿Quiénes pueden acceder al Club WOM?', opciones: ['Solo clientes con plan (postpago)', 'Solo clientes nuevos, durante su primer mes', 'Clientes postpago, prepago (con recarga vigente) y fibra, cada uno desde su app', 'Solo quienes portaron su número desde otra compañía'], correcta: 2, explicacion: 'Acceden postpago (App WOM/MiWOM), prepago con recarga en los últimos 30 días, y fibra (MiWOM Fibra). Es un beneficio transversal de ser cliente WOM.' },
      { id: 'cw-04', objetivoId: 'cw-que-es', enunciado: 'Un cliente pregunta de qué tipo son los descuentos del Club WOM. ¿Cuál es la mejor respuesta?', opciones: ['Solo de telefonía y equipos WOM', 'Solo de un comercio a la vez, que cambia cada año', 'Únicamente descuentos en la boleta WOM', 'De varias categorías —entretención, comida, retail, hogar y más— y el detalle vigente lo ve en la app'], correcta: 3, explicacion: 'El valor está en la variedad de categorías (cine, comida, retail, hogar, viajes). Como los comercios y porcentajes rotan, lo correcto es orientar al cliente a la app para el detalle vigente, no memorizar la lista.' },
      { id: 'cw-05', objetivoId: 'cw-que-es', enunciado: 'Un cliente postpago quiere ver sus beneficios. ¿Dónde los encuentra?', opciones: ['En la App WOM o MiWOM, en la sección Beneficios', 'Llamando cada vez al call center', 'Solo en las tiendas físicas WOM', 'En un correo que llega una vez al año'], correcta: 0, explicacion: 'Los beneficios se ven y se activan en la App WOM / MiWOM, sección Beneficios. Enseñarle al cliente el camino lo hace autónomo.' },
      { id: 'cw-06', objetivoId: 'cw-uso', enunciado: '¿Cómo obtiene el cliente un descuento del Club WOM?', opciones: ['Muestra su cédula en el local y listo', 'El descuento se aplica solo en la boleta WOM a fin de mes', 'Elige el beneficio en la app, revisa sus condiciones y genera un código que usa en tienda u online', 'Debe llamar a soporte para que se lo activen'], correcta: 2, explicacion: 'El flujo es: elegir el beneficio en la app, revisar sus términos, generar el código y usarlo en la compra (presencial u online) siguiendo las instrucciones.' },
      { id: 'cw-07', objetivoId: 'cw-uso', enunciado: 'Un cliente quiere descargar 5 códigos distintos el mismo día. ¿Qué le dices?', opciones: ['Puede descargar los que quiera, sin límite', 'Hay un tope de 3 códigos por día; algunos beneficios tienen límites propios por semana o mes', 'Solo puede tener un código activo en toda su vida como cliente', 'Los códigos no tienen ninguna restricción de cantidad'], correcta: 1, explicacion: 'El tope general es de 3 códigos por día, y ciertos beneficios tienen restricciones adicionales. Saberlo evita prometer algo que la app no permitirá.' },
      { id: 'cw-08', objetivoId: 'cw-uso', enunciado: 'Un cliente quiere pasarle su código de descuento a un amigo que no es de WOM. ¿Qué corresponde?', opciones: ['Puede compartirlo sin problema', 'Puede, pero solo una vez al mes', 'Puede, si el amigo se registra después', 'No: los códigos son exclusivos e intransferibles para clientes WOM'], correcta: 3, explicacion: 'Los códigos son personales e intransferibles: son un beneficio por ser cliente WOM. Compartirlos puede invalidarlos.' },
      { id: 'cw-09', objetivoId: 'cw-uso', enunciado: 'El local tiene su propia promo del día y el cliente quiere sumarla al descuento del Club WOM. ¿Qué le explicas?', opciones: ['Siempre se pueden acumular todos los descuentos', 'Por lo general los beneficios no son acumulables con otras promociones; conviene revisar los términos en la app', 'El código del Club WOM reemplaza cualquier precio del local', 'Debe elegir el más caro de los dos'], correcta: 1, explicacion: 'Los beneficios normalmente no se acumulan con otras promociones. Cada beneficio trae sus términos en la app; revisarlos antes evita el reclamo en caja.' },
      { id: 'cw-10', objetivoId: 'cw-uso', enunciado: 'Antes de usar un código online, ¿qué es lo más importante que debe hacer el cliente?', opciones: ['Revisar las condiciones del beneficio (vigencia, días válidos y pasos) antes de comprar', 'Nada, el código funciona siempre', 'Llamar al call center para confirmarlo', 'Esperar a que el local le avise'], correcta: 0, explicacion: 'Cada beneficio tiene condiciones (días válidos, vigencia, compra mínima, pasos). Revisarlas antes de comprar evita que el descuento no se aplique.' },
      { id: 'cw-11', objetivoId: 'cw-recomendar', enunciado: 'Un cliente joven, sensible al precio, quiere irse a la competencia por $2.000 de diferencia en el plan. ¿Cuál es la mejor jugada con el Club WOM?', opciones: ['Ofrecerle bajar el plan para igualar el precio', 'No mencionar los beneficios para no complicar la conversación', 'Mostrarle que solo por ser WOM ya tiene beneficios (cine, comida, retail) que superan esos $2.000, y enseñarle a canjearlos en la app', 'Decirle que revise la web cuando tenga tiempo'], correcta: 2, explicacion: 'El Club WOM es una herramienta de retención: traducir el beneficio a la plata que el cliente ya está dejando de aprovechar cambia la percepción de valor mejor que competir peso a peso.' },
      { id: 'cw-12', objetivoId: 'cw-recomendar', enunciado: 'Una clienta cuenta que sale seguido al cine con sus hijos. ¿Qué beneficio del Club WOM le conviene destacar?', opciones: ['Ninguno, mejor no ofrecer nada', 'Los beneficios de entretención (por ejemplo, promociones en cine), y mostrarle cómo generarlos desde la app', 'Solo descuentos en equipos', 'Un plan más caro con más gigas'], correcta: 1, explicacion: 'Recomendar según el perfil (cine, comida, viajes) hace el beneficio relevante. Conectar el beneficio con la vida del cliente es lo que crea valor percibido.' },
      { id: 'cw-13', objetivoId: 'cw-recomendar', enunciado: 'Un cliente prepago sin recarga vigente te pide un código de descuento ahora mismo. ¿Qué haces?', opciones: ['Le generas el código igual desde tu sistema', 'Le dices que el Club WOM no es para prepago', 'Le pides que llame otro día', 'Le explicas que primero necesita una recarga para activar su acceso, lo acompañas a hacerla y luego podrá canjear en la app'], correcta: 3, explicacion: 'El prepago sí accede, pero necesita recarga vigente (últimos 30 días). Resolver el requisito en el momento convierte una negativa en una venta (la recarga) y un beneficio.' },
      { id: 'cw-14', objetivoId: 'cw-recomendar', enunciado: 'No estás seguro de si un beneficio puntual sigue vigente hoy y el cliente te insiste. ¿Qué es lo correcto?', opciones: ['Decirle que los beneficios rotan, invitarlo a verlo en la app en el momento y, si puedes, confirmarlo juntos', 'Afirmarle que sí está vigente para no quedar mal', 'Inventar un descuento parecido', 'Cortar el tema y ofrecer otra cosa'], correcta: 0, explicacion: 'Como el catálogo cambia, sobreprometer genera reclamos. Orientar a la app (fuente vigente) protege la confianza y de todos modos crea valor.' },
      { id: 'cw-15', objetivoId: 'cw-valor', enunciado: 'Terminas de resolver una consulta de boleta con un cliente al día. ¿Cuál es una buena forma de sumar valor con el Club WOM?', opciones: ['Cerrar la llamada sin agregar nada', 'Leerle la lista completa de todos los comercios', 'Mencionarle, breve y natural, que por ser cliente WOM tiene beneficios en la app y darle un ejemplo que le pueda servir', 'Ofrecerle cambiar de plan aunque no lo pidió'], correcta: 2, explicacion: 'Un cierre con un beneficio relevante y breve eleva la percepción de valor sin alargar la llamada. Leer toda la lista, en cambio, satura y no conecta.' },
      { id: 'cw-16', objetivoId: 'cw-valor', enunciado: 'Un cliente dice que esos descuentos no le sirven. ¿Cuál es la mejor respuesta?', opciones: ['Darle la razón y cerrar el tema', 'Preguntarle qué suele consumir (comida, cine, viajes) para orientarlo al beneficio que sí le calce', 'Insistir con el mismo beneficio que rechazó', 'Decirle que igual los use'], correcta: 1, explicacion: 'La objeción suele ser falta de relevancia, no de interés. Indagar el hábito del cliente permite ofrecer el beneficio correcto y dar vuelta la percepción.' },
      { id: 'cw-17', objetivoId: 'cw-valor', enunciado: 'El cliente se interesa y pregunta cómo lo usa. ¿Qué haces?', opciones: ['Lo guías paso a paso: entrar a la app, ir a Beneficios, elegir, generar el código y usarlo en la compra', 'Le dices que es complicado y mejor lo vea después', 'Le pides que vaya a una tienda física', 'Le generas tú el código por él, siempre'], correcta: 0, explicacion: 'Acompañar el cómo en el momento convierte el interés en uso real. Un cliente que canjea una vez entiende el valor y vuelve.' },
      { id: 'cw-18', objetivoId: 'cw-valor', enunciado: '¿Cuál frase comunica mejor el valor del Club WOM?', opciones: ['Tenemos convenios con varios comercios.', 'Hay una sección de beneficios en la app.', 'Después revíselo si quiere.', 'Solo por ser WOM, con un par de canjes al mes ya recuperas gran parte de lo que pagas por tu plan.'], correcta: 3, explicacion: 'Traducir el beneficio a plata concreta que el cliente ahorra es mucho más persuasivo que enunciar que hay convenios. El valor se siente cuando es tangible.' },
    ],
  },
]
